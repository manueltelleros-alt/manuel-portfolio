...
export function Hero() {
  ...
  <a
    href="#projects"
    onClick={(e: MouseEvent<HTMLAnchorElement>) => handleScroll(e, '#projects')}
  ...
  <a
    href="#contact"
    onClick={(e: MouseEvent<HTMLAnchorElement>) => handleScroll(e, '#contact')}
    className="inline-flex items-center justify-center border border-gray-300 text-gray-700 px-6 py-3 text-sm font-medium rounded-full hover:border-gray-400 hover:text-gray-900 transition-colors text-center transition-all duration-300 ease-in-out transform hover:bg-gray-800 hover:scale-105 hover:shadow-lg"
  >
    Get in Touch
  </a>
</div>
