...
function SkillCard({
  ...
  return (
    <FadeIn delay={delay} className={className}>
      <div id={id} className="h-full bg-white rounded-2xl shadow-sm p-6 text-center border border-gray-200 
...
export function Skills() {
  ...
  >
    <CodeIcon className="w-5 h-5 text-blue-600" />
      ...
      <SkillCard
        title="Frameworks"
        skills={['React', 'Next.js', 'Node.js', 'Laravel (PHP)']}
      ...
      <SkillCard
        title="Tools"
        skills={['Browser & Search', 'Docker', 'PostgreSQL', 'Redis', 'Git']}
